        ...
        <ul class="nav nav-tabs" id="nav">
            <nav class="navbar nav-default navbar-inverse navbar-fixed-top "  >
                ...
                <div class="navbar-collapse collapse">
                      ...
                      <li>
                       <img src="img/l.jpg" class="img-circle" alt="Cinque Terre" width="70px;" height="60px;" >

                       </li>
                          <li class="active"><a href="" style="color: red;">Online Quize System </a></li>
            ...
            <div class="col-md-6" >
                <div class="customDiv">
                    ...
                    <div class="d-flex justify-content-center text-primary p-3">
                        <center> <h2 class="logo">Login Admin</h2></center>
                    </div>      
                    <br>


                    <form action="vali.php" method="POST" style="border:grey; border-width:5px; border-style:solid;">
